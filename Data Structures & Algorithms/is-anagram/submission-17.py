class Solution:
    def isAnagram(self, s: str, t: str) -> bool:
        # Prerequisite: Checks if the two words lengths are the same
        ...
        # there are characters that are diferrent between the strings,
        # which makes the check false
        for val in count:
            if val != 0:
                return False
            
        # No checks failed, which means the two strings are anagrams
        return True